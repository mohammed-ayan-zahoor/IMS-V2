    ...
    try {
        ...
        if (body.settings) {
            ...
            if (body.settings.features) {
                ...
                const allowedFeatures = ['exams', 'attendance', 'fees', 'materials', 'transport', 'hostel', 'bundleHostelInBaseFee', 'bundleTransportInBaseFee', 'combinedCourseFees', 'rteAndScholarship'];
