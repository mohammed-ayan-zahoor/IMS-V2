...
export default function StudentLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-white text-foreground flex flex-col">
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-border z-50 px-2 sm:px-6 pt-3 pb-6 safe-area-pb">
                <div className="flex justify-between sm:justify-around items-center overflow-x-auto scrollbar-hide gap-1 px-1">
                    {navItems.map((item) => {
                        const isActive = pathname === item.href;
                        return (
                            <Link
                                ...
                                href={item.href}
                                className={cn(
                                    "flex flex-col items-center gap-1 transition-colors relative min-w-[3rem] sm:min-w-[3.5rem]",
