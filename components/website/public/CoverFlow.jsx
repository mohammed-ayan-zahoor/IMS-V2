...
export function CoverFlow({
  ...
  const onDragEnd = useCallback(
    (_, info) => {
      ...
      const prev = activeIndexRef.current;
      const dir = clamped >= prev ? 'right' : 'left';
      setActiveIndex(clamped);
      scrollX.set(clamped);
      ...
      >
        ...
        <div className="absolute bottom-8 left-0 right-0 flex flex-col items-center justify-center pointer-events-none z-40">
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className="text-2xl font-semibold text-slate-800 dark:text-white tracking-tight drop-shadow-md">
    ...
    >
      ...
      {showReflection && (
        ...
        >
          ...
          <div
            className="absolute inset-0 pointer-events-none bg-gradient-to-t from-white via-white/70 to-transparent dark:from-slate-900 dark:via-slate-900/70"
          />
        </div>
      )}
    </motion.div>
